        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li
              ...
              v-for="(toggle, index) in floorList.navList"
              :key="index"
            >
              <a :href="toggle.url" data-toggle="tab">{{ toggle.text }}</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(jdList, index) in floorList.keywords" :key="index">
                  {{ jdList }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
              <Carsousel :list="floorList.carouselList" :delay = '2000'/>
            </div>
            <div class="split">
